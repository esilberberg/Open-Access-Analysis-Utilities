...
orcid_list = [
    {'name': 'Bergey', 'orcid': '0000-0002-0495-7219'},
    {'name': 'Gray-Nicolas', 'orcid': '0000-0001-8548-6502'},
    {'name': 'Silberberg', 'orcid': '0000-0002-2216-7632'}
]

orcid = '0000-0001-8548-6502'
...
if orcid_record:
    ...
    if works:
        for work in works:
            ...
            journal = work.get('journal-title', {}).get('value', 'No journal')
            ...
            if issn_l != 'No ISSN-L':
                ...
                journal_permissions = []
                permitted_oa_list = jisc_data.get('items', [{}])[0].get('publisher_policy', [{}])[0].get('permitted_oa', [])
                ...
                for policy in permitted_oa_list:
                    ...
                    # print(f'Version: {article_version.title()} | Additional OA Fee: {oa_fee.title()} | Embargo Period: {embargo_text} | Permitted Places to Deposit: {locations} | Named Repositories: {named_repos}')
...
df = pd.DataFrame(results, columns=['ORCID', 'Author', 'DOI', 'Article', 'Year', 'Journal', 'ISSN-L', 'OA Status', 'Journal Permissions'])
